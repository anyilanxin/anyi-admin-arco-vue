  ...
  <AnYiPageWrapper>
    <div class="container">
      <a-form ref="formRef" layout="vertical" :model="formData">
          ...
          <a-card class="general-card">
            ...
            <a-row :gutter="80">
              ...
              <a-col :span="8">
                <a-form-item
                  :label="
                    $t('groupForm.form.label.video.acquisition.resolution')
                  "
              ...
              <a-col :span="8">
                <a-form-item
                  :label="
                    $t('groupForm.form.label.video.acquisition.frameRate')
                  "
            ...
            <a-row :gutter="80">
              <a-col :span="8">
                <a-form-item
                  :label="
                    $t('groupForm.form.label.video.encoding.rate.default')
                  "
            ...
            <a-row :gutter="80">
              <a-col :span="8">
                ...
                >
                  <a-input
                    :placeholder="
                      $t('groupForm.placeholder.audio.encoding.rate')
                    "
                  >
                    <template #append> bps </template>
                  </a-input>
        ...
        <div class="actions" :style="contentWidthStype">
          <a-space>
            <a-button>
              {{ $t('groupForm.reset') }}
            </a-button>
...
<script lang="ts" setup>
  ...
  const { contentWidthStype } = useMenu();
</script>
